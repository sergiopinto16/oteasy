    ...
    <div className="post-page">
      ...
      {userInfo.id === sessionInfo.author._id && (
        <div className="edit-row">
          <Link className="edit-btn" to={`/edit/${sessionInfo._id}`}>
      ...
      <div className="image">
        <img src={api_host + '/${sessionInfo.cover}'} alt=""/>
      </div>
      <div className="content" dangerouslySetInnerHTML={{__html:sessionInfo.content}} />
    </div>
  );
}