...
import './SPM.css'
import calc_SPMcasa, { calc_a, calc_cc, calc_go, calc_me, calc_pmi, calc_ps, calc_pv, calc_t, calc_v, calc_total } from "./calc/calc_SPMcasa";
...
export default function SPMCasa() {
    ...
    async function calculate_spm_casa(ev) {
        ...
        const response = await fetch(api_host + '/api/spm/add', {
            ...
            //     "2023-04-28 19:02", 
            //     valueArray, 
            //     "evaluation reason", scoreQuestions,
            //     tscoreQuestions,
    ...
    return (
        ...
        <form className="spm_casa"  >
            ...
            <div className="spm_calculate_button">
                ...
                <button onClick={calculate_spm_casa}>Export to  PDF (NOT WORKING)</button>
