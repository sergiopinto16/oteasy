...
import './Spm.css'
import calc_SPMpescola, { calc_a, calc_cc, calc_go, calc_me, calc_pmi, calc_ps, calc_pv, calc_t, calc_v, calc_total } from "./calc/calc_SpmpEscola";
    ...
    return (
        <form className="spm_p_escola" >
            ...
            <div className="button_form_download" >
                <button className="spm_p_escola" onClick={() => window.open(require('../../static/SPM/docs/SPM-p_Escola_TUDO_COMPLETO(2-5Anos).pdf'), '_none')}> Donwload Formulário</button>
            </div>
            ...
            <div id="PS" className="question_group" >
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_10"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>
            ...
            <div id="VISAO" className="question_group">
                ...
                <div className="question">
                    <p>11. Pisca os olhos, tapa os olhos ou queixa-se da luz da sala ou da
                        luz do sol</p>
                    <SpmRadioAnswer name={"question_11"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>

                <div className="question">
                    <p>12. Distrai-se com objetos próximos ou pessoas (imagens, figuras nas
                        paredes, janelas, outras crianças, etc)</p>
                    <SpmRadioAnswer name={"question_12"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>

                <div className="question">
                    <p>13. Tem dificuldade em localizar objectos ou pessoas ao olhar ao
                        redor da sala ou do espaço de brincadeira</p>
                    <SpmRadioAnswer name={"question_13"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>

                <div className="question">
                    <p>14. Tem dificuldade em encontrar um objeto pretendido entre vários
                        espalhados na secretária ou na mesa</p>
                    <SpmRadioAnswer name={"question_14"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_15"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>

                <div className="question">
                    <p>16. Tem dificuldade em identificar objetos pela cor ou pela forma</p>
                    <SpmRadioAnswer name={"question_16"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>

                <div className="question">
                    <p>17. Vai de encontro aos outros que estão a brincar no espaço de jogo</p>
                    <SpmRadioAnswer name={"question_17"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>

                <div className="question">
                    <p>18. Fixa intensamente pessoas ou objetos</p>
                    <SpmRadioAnswer name={"question_18"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>

                <div className="question">
                    <p>19. Fixa intensamente pessoas ou objetos</p>
                    <SpmRadioAnswer name={"question_19"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>

                <div className="question">
                    <p>20. Gosta de observar objectos a mover pelo canto do olho</p>
                    <SpmRadioAnswer name={"question_20"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>
            ...
            <div id="AUDICAO" className="question_group">
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_21"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
                ...
                <div className="question">
                    <p>22. Mostra stress quando os colegas cantam ou usam instrumentos
                        musicais</p>
                    <SpmRadioAnswer name={"question_22"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>

                <div className="question">
                    <p>23. Permanece ignorar novas vozes ou novos sons na sala</p>
                    <SpmRadioAnswer name={"question_23"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} />
                </div>

                <div className="question">
                    <p>24. Permanece ignorar novas vozes ou novos sons na sala</p>
                    <SpmRadioAnswer name={"question_24"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>25. Faz barulhos, grunhidos, canta ou grita durante momentos de aula
                        silenciosos</p>
                    <SpmRadioAnswer name={"question_25"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>26. Gosta de provocar certos sons repetidamente (ex: puxar várias
                        vezes o autoclismo)</p>
                    <SpmRadioAnswer name={"question_26"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>27. Parece não ter consciência de sons que são notados pelos outros</p>
                    <SpmRadioAnswer name={"question_27"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>28. Tem dificuldade em estar atento quando a sala de aula é
                        barulhenta</p>
                    <SpmRadioAnswer name={"question_28"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>29. Parece incapaz de seguir direções verbais</p>
                    <SpmRadioAnswer name={"question_29"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_30"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
            ...
            <div id="TOQUE" className="question_group">
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_31"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>32. Mostra stresse quando as mãos ou a cara estão sujas (ex: cola,
                        tintas nos dedos, comida, etc)</p>
                    <SpmRadioAnswer name={"question_32"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>33. Mostra stresse quando lava as mãos quer em água quente quer em
                        água fria</p>
                    <SpmRadioAnswer name={"question_33"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>34. Fica stressado com o toque acidental dos colegas (Sacode onde
                        foi tocado ou afasta-se dos colegas)</p>
                    <SpmRadioAnswer name={"question_34"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>35. Não limpa a saliva ou restos de comida na cara</p>
                    <SpmRadioAnswer name={"question_35"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>36. Fica stressado ao tocar em certas texturas (materias da sala,
                        utensílios, equipamentos desportivos, etc)</p>
                    <SpmRadioAnswer name={"question_36"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>37. Recusa vestir outras roupas por cima (ex: batas, kispos)</p>
                    <SpmRadioAnswer name={"question_37"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_38"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>39. Parece não ter consciência da necessidade de usar a sanita (quer
                        tenha xixi ou cócó)</p>
                    <SpmRadioAnswer name={"question_39"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>40. Evita tocar ou brincar com digitintas, plasticinas, pastas de
                        modelar, areias, colas ou outros materiais)</p>
                    <SpmRadioAnswer name={"question_40"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
            ...
            <div id="GOSTO_E_OLFATO" className="question_group">
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_41"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>42. Parece indiferente perante odores fortes ou pouco vulgares (ex:
                        cola, tinta, marcadores etc)</p>
                    <SpmRadioAnswer name={"question_42"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>43. Fica stressado perante o cheiros da sopa, perfume, laca do
                        cabelo ou loções do corpo</p>
                    <SpmRadioAnswer name={"question_43"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>44. Fica stressado com o sabor da comida comparativamente às outras
                        crianças da mesma idade</p>
                    <SpmRadioAnswer name={"question_44"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>45. Recusa experimentar novas comidas</p>
                    <SpmRadioAnswer name={"question_45"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
            ...
            <div id="CONSCIENCIA_CORPORAL" className="question_group">
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_46"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>47. Carrega no papel com muita força e parte com facilidade pontas
                        dos lápis, crayons e batons de cola</p>
                    <SpmRadioAnswer name={"question_47"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>48. Salta constantemente; procura saltar para o chão de locais altos</p>
                    <SpmRadioAnswer name={"question_48"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>49. Fecha ou abre as portas com excessiva força</p>
                    <SpmRadioAnswer name={"question_49"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_50"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>51. Vai de encontro aos colegas com frequência (ex: enquanto está na
                        fila ou enquanto se move no espaço onde brinca)</p>
                    <SpmRadioAnswer name={"question_51"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>52. Mastiga ou morde roupa, lápis, crayons, ou outros materiais da
                        sala</p>
                    <SpmRadioAnswer name={"question_52"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>53. Transporta comida ou conteúdos de bebida bruscamente (pode
                        amassar, partir ou deixar cair o conteúdo que transporta)</p>
                    <SpmRadioAnswer name={"question_53"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>54. Derruba as construções que as outras crianças fizeram (ex:
                        torres de blocos, esculturas, estradas, carruagens)</p>
                    <SpmRadioAnswer name={"question_54"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>55. Quando está a recortar, fecha a tesoura com demasiada força</p>
                    <SpmRadioAnswer name={"question_55"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
            ...
            <div id="MOVIMENTO_E_EQILIBRIO" className="question_group">
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_56"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>57. Encosta-se às paredes, móveis ou pessoas como forma de apoio
                        enquanto está de pé</p>
                    <SpmRadioAnswer name={"question_57"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_58"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_59"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>60. Prefere actividades movimentadas</p>
                    <SpmRadioAnswer name={"question_60"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>61. Fica desorientada ou mostra receio quando se baixa para apanhar
                        objectos do chão</p>
                    <SpmRadioAnswer name={"question_61"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>62. Tem dificuldade em recompor-se quando falha numa actividade</p>
                    <SpmRadioAnswer name={"question_62"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>63. Fica stressada quando está em equipamentos altos</p>
                    <SpmRadioAnswer name={"question_63"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>64. Tem uma coordenação pobre</p>
                    <SpmRadioAnswer name={"question_64"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>65. Tem dificuldade em acompanhar ritmos (ex: bater palmas ou pés
                        segundo o ritmo)</p>
                    <SpmRadioAnswer name={"question_65"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
            ...
            <div id="PLANEAMENTO_MOTOR_E_IDEACAO" className="question_group" >
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_66"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
                ...
                <div className="question">
                    <p>67. Tem dificuldade em introduzir novas ideias durante as
                        actividades</p>
                    <SpmRadioAnswer name={"question_67"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>68. Brinca de forma repetida durante o jogo livre; não modifica a
                        actividade de forma a aumentar o desafio</p>
                    <SpmRadioAnswer name={"question_68"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>69. Necessita de adereços reais para se envolver no jogo funcional
                        (ex: brincar com telefone)</p>
                    <SpmRadioAnswer name={"question_69"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_70"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>71. Brinca com os seus próprios jogos, evita imitar os outros</p>
                    <SpmRadioAnswer name={"question_71"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>72. Tem dificuldade em copiar as construções com blocos do adulto ou
                        de outra criança</p>
                    <SpmRadioAnswer name={"question_72"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_73"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>

                <div className="question">

                    <p>74. Não consegue completar tarefas com multiplos passos</p>
                    <SpmRadioAnswer name={"question_74"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
                ...
                <div className="question">
                    ...
                    <SpmRadioAnswer name={"question_75"} color={"red"} callbackValueRadio={getRadioValue} text={SpmRadioAnswerText} /></div>
            ...
            <div className="spm_calculate_button">
                ...
                <button className="spm_p_escola" onClick={calculate_spm_p_escola}>Export to  PDF (NOT WORKING)</button>
